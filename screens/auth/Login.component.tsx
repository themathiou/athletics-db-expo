...
// TODO: CONSIDER MERGE WITH REGISTER
// TODO: fix props type
    ...
    <ScrollView style={styles.screen}>
      <KeyboardAvoidingView style={styles.screen} behavior='position'>
        <View style={styles.rootContainer}>
          ...
          <Button label={'Login'} onPress={handleSubmit(onSubmit)} size={Button.sizes.large} marginB-20 />

          <Button label={'Create new account'} onPress={() => navigation.navigate('register')} hyperlink marginB-10 />
          <Button
